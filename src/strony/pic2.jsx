 ...
 function PicModal(props){
  const adress=useContext(adressContext)
    ...
    return(
        <>
        <div>
                 {props.photo? <img src={URL.createObjectURL(props.photo)} onClick={()=>handleOpen()} alt="Image Preview" style={{ objectFit: 'contain', maxHeight:430, maxwidth:350 }}/> : <img src={adress+props.photoParams.LINK} onClick={()=>handleOpen()} alt={adress+props.photoParams.ALT} style={{ objectFit: 'contain', maxHeight:430, maxwidth:350 }} />}
                 </div>
